...
<!-- ### Example 7: China with Provinces -->
<!-- The basemap `map.chn` can be used to plot data corresponding with Chinese provinces.  -->
...
```{r mp9, fig.width=4, fig.height=6, fig.align='center'}
w <- read.csv('~/../Downloads/examplewater.csv', stringsAsFactors = F)
w <- add_region_ID(w, disaggregate = 'scenario')
plot_GCAM(map.rgn32.simple, col='value', legend=T, gcam_df=w) + 
    ggplot2::scale_fill_gradientn(colors = c("deepskyblue", "firebrick1"),
                                  na.value = gray(0.9),
                                  name="Water Dependency in 2100") +
